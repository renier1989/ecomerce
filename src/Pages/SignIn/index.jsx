...
function SignIn() {
  ...
  const noAccountInLocalStorage = parsedAccount
    ...
    : true;
  const noAccountInLocalState = ecom.account
    ? Object.keys(ecom.account).length === 0
    : true;
  ...
  const renderLogin = () => {
    return (
      <div>
        ...
        <Link to="/ecomerce/">
          <button
            className="w-full py-3 bg-black disabled:bg-black/40 rounded-lg text-white mt-4 mb-3"
        ...
        <div className={`${hasUserAccount ? 'flex gap-6': ''}`}>
          <div className="text-center">
            <a href="/ecomerce/" className="underline">
              {" "}
        ...
        <button
          className=" border border-black text-center rounded-lg py-3 w-full mt-4 disabled:text-black/40 disabled:border-black/40"
        ...
        <form ref={form}>
          <div className="flex flex-col mb-3">
            ...
            <input
              ...
              id="name"
              name="name"
              className="font-semibold px-4  border border-black py-2 rounded-lg"
              placeholder="Peter"
